...
// Enable test-only routes (e.g. /smoke/explainer for RevealExplainer
// e2e). Read at build time by the gated pages; production CI does not
// set this so the test-page bodies render an inert placeholder on
// atlas-rust-one.vercel.app and andreastersenov.github.io/atlas/.
